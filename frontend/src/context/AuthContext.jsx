...
// this is the context that will be used to provide the user data to all the components

export const useAuthContext = () => {
    return useContext(AuthContext);
    // useContext is used to access the context that is provided by the AuthContext.Provider
 } 
